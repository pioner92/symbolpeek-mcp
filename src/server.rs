...
impl SymbolPeekServer {
    #[tool(
        description = "[.ts/.tsx/.js/.jsx/.rs/.py/.java/.go/.json/.md/.markdown] Exact symbol source + trust metadata."
    )]
    ...
    #[tool(
        description = "[.ts/.tsx/.js/.jsx/.rs/.py/.java/.go/.json/.md/.markdown] Top-level symbols; rows=fields; one file/page; offset/next_offset."
    )]
    ...
    #[tool(
        description = "[.ts/.tsx/.js/.jsx/.rs/.py/.java/.go/.json/.md/.markdown] Workspace declarations; stable rows=fields; file_idx are page-local; offset/next_offset."
    )]
    ...
    #[tool(
        description = "[.ts/.tsx/.js/.jsx/.rs/.py/.java/.go/.json/.md/.markdown] Nested declarations; recursive rows follow fields at every level."
    )]
